...
# reset the graphics setting to 1 picture, set parameters
par(mfrow=c(1,1))
color <- "red"
main <- "Global Active Power"
ylab <- "Frequency"
xlab <- "Global Active Power (kilowatts)"
hist(data_small$Global_active_power,col=color, main=main, ylab=ylab, xlab=xlab)
